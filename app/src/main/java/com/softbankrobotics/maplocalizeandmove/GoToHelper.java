...
class GoToHelper {
    ...
    private static String TAG = "GoToHelper";
     ...
     * @return Future of the GoTo
     */
    Future<Void> goTo(AttachedFrame attachedFrame) {
        ...
        goTo.async()
                ...
                .thenConsume(goToResult -> {
                    ...
                    if (goToResult.isSuccess()) {
                        ...
                        FutureUtils.wait((long) 1.5, TimeUnit.SECONDS)
     ...
     */
    interface onStartedMovingListener {
        void onStartedMoving();
    }

    interface onFinishedMovingListener {
        void onFinishedMoving(boolean success);
    }

    void addOnStartedMovingListener(onStartedMovingListener f) {
        startedListeners.add(f);
    }

    void addOnFinishedMovingListener(onFinishedMovingListener f) {
